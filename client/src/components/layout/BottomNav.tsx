...
const agentNavItems: BottomNavItem[] = [
  { to: '/', label: 'Accueil', icon: <IconHome /> },
  { to: '/enlevements/nouveau', label: 'Nouveau', icon: <IconPlus /> },
  { to: '/enlevements', label: 'Liste', icon: <IconList /> },
  { to: '/documents', label: 'Docs', icon: <IconDocument /> },
...
export default function BottomNav() {
  const { isFourriere, isAdmin, isDleOffice } = useAuth()
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 z-30 md:hidden safe-area-bottom">
